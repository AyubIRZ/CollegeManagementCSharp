...
namespace sama_win
{
    public partial class deleteMaster : Form
    {
        ...
        private void deleteMaster_Load(object sender, EventArgs e)
        {
        ...
        private void btn_del_Click(object sender, EventArgs e)
        {
            if (textBox1.Text!="")
            {
                if (MessageBox.Show(" آیا از حذف استاد مطمئن هستید؟ ", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    string ctext1 = "delete from Teacher where Tno = '" + textBox1.Text + "'", ctext2 = "delete from Course where Tno = '" + textBox1.Text + "'";
                    try
                    {
                        OleDbConnection con1 = new OleDbConnection("provider=Microsoft.ace.oledb.12.0;data source=university.accdb");
                        con1.Open();
                        ...
                        c1.ExecuteNonQuery();
                        con1.Close();
                        MessageBox.Show(" استاد و درس های آن با موفقیت حذف شدند ");
                    ...
                    {
                        MessageBox.Show(" :مشکل در حذف استاد \n " + ex.Message);
                    }
                }
            }
        }
